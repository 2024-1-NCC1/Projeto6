...
public class TrackAfrica : MonoBehaviour
{
    [System.Serializable]
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            transform.position = new Vector3(0.2498706f, 2.977477f, transform.position.z + trackLength);
